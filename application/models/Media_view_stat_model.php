...
class Media_view_stat_model extends CB_Model
{
    ...
    {   
        ...
        $qry = $this->db->query('SELECT A.post_id,A.brd_id,A.mvs_datetime,A.mvs_cnt,A.mvs_code from (SELECT post_id,brd_id,count(*) as mvs_cnt, left(mvl_datetime, 13) as mvs_datetime,mvl_code as mvs_code from cb_media_view_log group by post_id,left(mvl_datetime, 13),mvl_code) A ');
