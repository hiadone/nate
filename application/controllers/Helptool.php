...
class Helptool extends CB_Controller
{
	...
	public function cmallitem_list($element_id='')
	{
		...
		$view['view']['element_id'] = $element_id;

		$this->load->model(array('Cmall_item_model','Cmall_category_model','Cmall_category_rel_model','Cmall_channel_model', 'Cmall_channel_rel_model'));
		...
		$this->Cmall_item_model->allow_search_field = array('cit_name', 'cit_datetime', 'cit_updated_datetime'); // 검색이 가능한 필드
		
		$this->Cmall_item_model->allow_order_field = array('cit_id', 'cit_key', 'cit_order', 'cit_name', 'cit_datetime', 'cit_updated_datetime', 'cit_hit', 'cit_sell_count', 'cit_price'); // 정렬이 가능한 필드
