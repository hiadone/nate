...
<div class="board">
	...
	?>
		...
		<div class="form-horizontal box-table">
			...
			?>
				<div class="form-group">					
					<label for="<?php echo $link_column; ?>" class="col-sm-2 control-label">슬롯 #<?php echo $i+1; ?></label>
					<div class="col-sm-10" style="display:table;">
						...
						<span class="input-group-btn">
							<button type="button" class="btn btn-xs btn-default" id="btn_cmallitem_list" onClick="open_cmallitem_list('<?php echo $link_column; ?>');">검색</button>
						</span>
					</div>
				</div>
			<?php
