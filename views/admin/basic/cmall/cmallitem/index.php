			...
			<div class="box-table-header">
				...
				?>
					<div class="btn-group pull-right" role="group" aria-label="...">
						...
						<button type="button" class="btn btn-outline btn-warning btn-sm btn-one-import" data-one-import-url = "<?php echo element('import_url', $view); ?>" >상품가져오기</button>
				...
				<table class="table table-hover table-striped table-bordered">
					...
					?>
						<tr>
							...
							<td><input type="text" name="cit_summary[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control" value="<?php echo html_escape(element('cit_summary', $result)); ?>" /></td>
							<td><input type="text" name="cit_price[<?php echo element(element('primary_key', $view), $result); ?>]" class="form-control" value="<?php echo html_escape(element('cit_price', $result)); ?>" /></td>
